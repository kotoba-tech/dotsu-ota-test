...
This repository hosts test release assets for Dotsu native OTA updates.
...
Current test URLs after these files are merged to `main`:

```text
https://raw.githubusercontent.com/kotoba-tech/dotsu-ota-test/main/manifests/ios.json
https://raw.githubusercontent.com/kotoba-tech/dotsu-ota-test/main/manifests/android.json
```
